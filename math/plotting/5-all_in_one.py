...
def all_in_one():
    ...
    ax2.set_xlabel("Men's Height vs Weight")
    ...
    ax4.plot(x3, y31, label="C-14", color="red", linestyle="--")
    ax4.plot(x3, y32, label="Ra-226", color="green", linestyle="-")
    ax4.set_xlabel("Time (years)")
    ax4.set_ylabel("Fraction Remaining")
    ax4.set_title("Exponential Decay of Radiactive")
    ax4.set_xlim(0, 20000)
    ax4.set_ylim(0,1)
    ax4.legend()

    ax5.hist(student_grades, bins=np.arange(0, 110, 10), edgecolor='black')
